...
def warmup():
    ...
    # slower to start
    time.sleep(5)
    main_head_move(15, 15, 1.5, 1, 3)
    time.sleep(5) # adjust as needed
    main_head_circle(30, 3)
    time.sleep(5)
    main_twist(20, 1.5, 1, 3)
    time.sleep(5)

    # normal speed
    main_head_move(15, 15, 0.75, 1, 4)
    time.sleep(2.5) # adjust as needed
    main_head_circle(20, 4)
    time.sleep(2.5)
    main_twist(20, 0.75, 1, 4)
    time.sleep(2.5)

    # faster
    main_head_move(15, 15, 0.25, 0.5, 5)
    time.sleep(1)
    main_head_circle(10, 5)
    time.sleep(1)
    main_twist(20, 0.25, 0.5, 5)
    time.sleep(5)
