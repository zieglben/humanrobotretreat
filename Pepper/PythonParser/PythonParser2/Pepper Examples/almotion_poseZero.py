...
def main(session):
    ...
    posture_service.goToPosture("dancemoves-a0f94b", 0.5)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ip", type=str, default="192.168.50.155",
                        help="Robot IP address. On robot or Local Naoqi: use '192.168.50.155'.")
